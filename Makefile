...
PROJECT_NAME ?= provider-akamai
PROJECT_REPO ?= github.com/footprint-it-solutions/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_SOURCE ?= akamai/akamai
export TERRAFORM_PROVIDER_REPO ?= https://github.com/akamai/terraform-provider-akamai
export TERRAFORM_PROVIDER_VERSION ?= 8.1.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-akamai
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-akamai_v8.1.0
...
xpkg.build.provider-akamai: do.build.images
