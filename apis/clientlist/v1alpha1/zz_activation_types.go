...
type ActivationInitParameters struct {
	...
	// +listType=set
	NotificationRecipients []*string `json:"notificationRecipients,omitempty" tf:"notification_recipients,omitempty"`

	// Identifies the Siebel ticket, if the activation is linked to one.
	SiebelTicketID *string `json:"siebelTicketId,omitempty" tf:"siebel_ticket_id,omitempty"`
