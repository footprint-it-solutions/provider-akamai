...
// DescriptionSpec defines the desired state of Description
type DescriptionSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     DescriptionParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider DescriptionInitParameters `json:"initProvider,omitempty"`
}

// DescriptionStatus defines the observed state of Description.
type DescriptionStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        DescriptionObservation `json:"atProvider,omitempty"`
}
...
// Description is the Schema for the Descriptions API. <no value>
...
// DescriptionList contains a list of Descriptions
...
var (
	...
	Description_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: Description_Kind}.String()
	Description_KindAPIVersion   = Description_Kind + "." + CRDGroupVersion.String()
	Description_GroupVersionKind = CRDGroupVersion.WithKind(Description_Kind)
)

func init() {
	SchemeBuilder.Register(&Description{}, &DescriptionList{})
}
