...
func (mg *ApiConstraintsProtection) GetTerraformResourceType() string {
	return "akamai_appsec_api_constraints_protection"
}
...
// LateInitialize this ApiConstraintsProtection using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ApiConstraintsProtection) LateInitialize(attrs []byte) (bool, error) {
	params := &ApiConstraintsProtectionParameters{}
