...
func (mg *AdvancedSettingsRequestBody) GetTerraformResourceType() string {
	return "akamai_appsec_advanced_settings_request_body"
}
...
// LateInitialize this AdvancedSettingsRequestBody using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AdvancedSettingsRequestBody) LateInitialize(attrs []byte) (bool, error) {
	params := &AdvancedSettingsRequestBodyParameters{}
