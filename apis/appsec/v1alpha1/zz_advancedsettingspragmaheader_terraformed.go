...
func (mg *AdvancedSettingsPragmaHeader) GetTerraformResourceType() string {
	return "akamai_appsec_advanced_settings_pragma_header"
}
...
func (tr *AdvancedSettingsPragmaHeader) GetID() string {
...
// LateInitialize this AdvancedSettingsPragmaHeader using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AdvancedSettingsPragmaHeader) LateInitialize(attrs []byte) (bool, error) {
	params := &AdvancedSettingsPragmaHeaderParameters{}
