...
func (mg *AdvancedSettingsAttackPayloadLogging) GetTerraformResourceType() string {
	return "akamai_appsec_advanced_settings_attack_payload_logging"
}
...
func (tr *AdvancedSettingsAttackPayloadLogging) GetID() string {
...
// LateInitialize this AdvancedSettingsAttackPayloadLogging using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AdvancedSettingsAttackPayloadLogging) LateInitialize(attrs []byte) (bool, error) {
	params := &AdvancedSettingsAttackPayloadLoggingParameters{}
