...
func (mg *SecurityPolicyDefaultProtections) GetTerraformResourceType() string {
	return "akamai_appsec_security_policy_default_protections"
}
...
func (tr *SecurityPolicyDefaultProtections) GetID() string {
...
// LateInitialize this SecurityPolicyDefaultProtections using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SecurityPolicyDefaultProtections) LateInitialize(attrs []byte) (bool, error) {
	params := &SecurityPolicyDefaultProtectionsParameters{}
