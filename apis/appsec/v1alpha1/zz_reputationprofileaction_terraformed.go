...
func (mg *ReputationProfileAction) GetTerraformResourceType() string {
	return "akamai_appsec_reputation_profile_action"
}
...
// LateInitialize this ReputationProfileAction using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ReputationProfileAction) LateInitialize(attrs []byte) (bool, error) {
	params := &ReputationProfileActionParameters{}
