...
func (mg *EvalPenaltyBoxConditions) GetTerraformResourceType() string {
	return "akamai_appsec_eval_penalty_box_conditions"
}
...
// LateInitialize this EvalPenaltyBoxConditions using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *EvalPenaltyBoxConditions) LateInitialize(attrs []byte) (bool, error) {
	params := &EvalPenaltyBoxConditionsParameters{}
