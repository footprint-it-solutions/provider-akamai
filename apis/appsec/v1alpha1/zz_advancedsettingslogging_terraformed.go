...
func (mg *AdvancedSettingsLogging) GetTerraformResourceType() string {
	return "akamai_appsec_advanced_settings_logging"
}
...
// LateInitialize this AdvancedSettingsLogging using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AdvancedSettingsLogging) LateInitialize(attrs []byte) (bool, error) {
	params := &AdvancedSettingsLoggingParameters{}
