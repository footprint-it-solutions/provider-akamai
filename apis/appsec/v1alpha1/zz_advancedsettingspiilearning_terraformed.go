...
func (mg *AdvancedSettingsPiiLearning) GetTerraformResourceType() string {
	return "akamai_appsec_advanced_settings_pii_learning"
}
...
// LateInitialize this AdvancedSettingsPiiLearning using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AdvancedSettingsPiiLearning) LateInitialize(attrs []byte) (bool, error) {
	params := &AdvancedSettingsPiiLearningParameters{}
