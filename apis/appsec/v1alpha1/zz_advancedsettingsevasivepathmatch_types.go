...
// AdvancedSettingsEvasivePathMatch is the Schema for the AdvancedSettingsEvasivePathMatchs API. <no value>
...
func init() {
	SchemeBuilder.Register(&AdvancedSettingsEvasivePathMatch{}, &AdvancedSettingsEvasivePathMatchList{})
}
