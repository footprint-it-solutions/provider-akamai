...
func (mg *AdvancedSettingsEvasivePathMatch) GetTerraformResourceType() string {
	return "akamai_appsec_advanced_settings_evasive_path_match"
}
...
func (tr *AdvancedSettingsEvasivePathMatch) GetID() string {
...
// LateInitialize this AdvancedSettingsEvasivePathMatch using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AdvancedSettingsEvasivePathMatch) LateInitialize(attrs []byte) (bool, error) {
	params := &AdvancedSettingsEvasivePathMatchParameters{}
