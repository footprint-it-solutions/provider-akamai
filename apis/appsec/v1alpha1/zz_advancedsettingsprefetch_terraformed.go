...
func (mg *AdvancedSettingsPrefetch) GetTerraformResourceType() string {
	return "akamai_appsec_advanced_settings_prefetch"
}
...
// LateInitialize this AdvancedSettingsPrefetch using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *AdvancedSettingsPrefetch) LateInitialize(attrs []byte) (bool, error) {
	params := &AdvancedSettingsPrefetchParameters{}
